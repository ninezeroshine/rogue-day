                ...
                <>
                    ...
                    >
                        <div className="bg-[var(--bg-card)] rounded-2xl p-5 border border-[var(--border-default)]">
                            <h2 className="text-xl font-bold mb-4">╨Э╨╛╨▓╨░╤П ╨╖╨░╨┤╨░╤З╨░</h2>
                        ...
                        `}
                            ...
                            {tierConfig.timerMode === 'optional' && (
                                <div className="mb-4 flex items-center justify-between">
                                    <div>
                                        <div className="text-sm font-medium">╨б ╤В╨░╨╣╨╝╨╡╤А╨╛╨╝</div>
                                        <div className="text-xs text-[var(--text-muted)]">
                                            {useTimer ? '100% XP, ╨╝╨╛╨╢╨╜╨╛ ╨┐╤А╨╛╨▓╨░╨╗╨╕╤В╤М' : '80% XP, ╨▒╨╡╨╖ ╤А╨╕╤Б╨║╨░'}
                                        </div>
                                    </div>
                                    <button
                      ...
                      `}
                            ...
                            <div className="mb-4 p-3 bg-[var(--bg-secondary)] rounded-xl">
                                <div className="flex justify-between items-center">
                                    <span className="text-sm text-[var(--text-muted)]">╨Э╨░╨│╤А╨░╨┤╨░:</span>
